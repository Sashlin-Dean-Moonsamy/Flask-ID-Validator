...
def is_valid(id_num, date_of_birth):
    ...
    try:
        ...
        year_of_birth = date_of_birth[-1]
        id_first_six_numbers = year_of_birth[2:] + "-" + date_of_birth[1] + "-" + date_of_birth[0]
        ...
        elif id_num[0:6] != id_first_six_numbers.replace("-", ""):
        ...
        return False, "ID Number/Date cannot contain letters"
